...
-- Как страны могут быть уникальны если они будут повторяться из-за того они имеют много городов?
...
SELECT AVG ( shipped_date::timestamp - order_date::timestamp )::interval
FROM orders
